...
def generate_comparison_table():
    ...
    print(alpha_beta_only[['Depth', 'Avg Time (ms)', 'Memory (MB)', 'Nodes Explored']].to_string(index=False))
    
    print("\n--- LATEX FORMAT (Clean Scalability Table) ---")
    print(alpha_beta_only[['Depth', 'Avg Time (ms)', 'Memory (MB)']].to_latex(
        index=False, 
